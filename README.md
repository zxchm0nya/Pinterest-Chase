...
Игра сама проверяет обновления в репозитории `zxchm0nya/Pinterest-Chase`. Сервер смотрит последний commit на GitHub. Если в репозитории появился новый commit, сервер напишет об этом в терминале, а в игре появится плашка со ссылкой на скачивание новой версии.

Ничего вручную менять в файлах версии не нужно: залил новый commit на GitHub - старые копии игры увидят обновление сами.
